...
define(["require", "jquery", "./PickingManager", "./ImageManager", "./ImageProcessing", "./SimpleProgressBar", "gw/Utils/UtilsCore", "service/Samp", "./dialog/ErrorDialog", "underscore-min", "text!templates/imageViewer.html", "text!templates/imageViewerLayerItem.html", "text!templates/imageViewerImageItem.html", "jquery.ui"],
    function (require, $, PickingManager, ImageManager, ImageProcessing, SimpleProgressBar, UtilsCore, Samp, ErrorDialog, _, imageViewerHTML, imageViewerLayerItemHTMLTemplate, imageViewerImageItemHTMLTemplate) {
...
// Template generating the li representing image
        ...
        function onVisibilityChange(layer) {
            ...
            $layerVisibility.button("option", {
                icons: {
                    primary: layer.getVisible() ? "ui-icon-check" : ""
                }
            }).button('refresh');
