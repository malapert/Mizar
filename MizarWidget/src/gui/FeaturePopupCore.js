 ...
 * FeaturePopup module
 */
define(["jquery", "underscore-min", "service/SampCore", "./ImageProcessingCore", "gw/Parser/JsonProcessor", "gw/Utils/Utils", "gw/Renderer/FeatureStyle", "gw/Layer/VectorLayer", "text!templates/featureList.html", "text!templates/featureDescription.html", "text!templates/descriptionTable.html"],
    function ($, _, SampCore, ImageProcessingCore, JsonProcessor, Utils, FeatureStyle, VectorLayer, featureListHTMLTemplate, featureDescriptionHTMLTemplate, descriptionTableHTMLTemplate) {
        ...
        function computeHeight() {
            return 2 * $('#' + planet.renderContext.canvas.id).height() / 5;
        }
        ...
        function showOrHideSolarObjectService() {
            ...
            if (selectedData.feature.services.solarObjects) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        // coordSystem: (planet.tileManager.imageryProvider.tiling.coordSystem == "EQ" ? "EQUATORIAL" : "GALACTIC")
                    },
                    success: function (response) {
            ...
            if ($('#solarObjects').is('.selected')) {
                ...
                solarObjectsLayer.setVisible(false);
            }
            else {
                $('#solarObjects').addClass('selected');
                solarObjectsLayer.setVisible(true);
            }
        }
        ...
        function selectFeatureOnTitle() {
            ...
            planet.renderContext.requestFrame();
