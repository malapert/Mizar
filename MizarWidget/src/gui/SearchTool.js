...
define(["jquery", "underscore-min", "./PickingManager", "./SelectionToolCore", "./PickingManager", "./LayerServiceView", "gw/Utils/Utils", "gw/Tiling/HEALPixBase"],
    function ($, _, PickingManager, SelectionToolCore, PickingManager, LayerServiceView, Utils, HealpixBase) {
        ...
        SearchTool.prototype.showLayerServices = function () {
            ...
            var selectedTile = mizar.navigation.planet.tileManager.getVisibleTile(self.coordinates[0][0], self.coordinates[0][1]);
