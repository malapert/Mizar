 ...
 * FeaturePopup module
 */
define(["jquery", "./FeaturePopupCore", "./IFrame", "gw/Utils/Utils", "./ImageProcessing", "service/Samp", "underscore-min", "text!templates/featureList.html", "text!templates/featureDescription.html", "text!templates/descriptionTable.html", "jquery.nicescroll.min", "jquery.ui"],
...
// PileStash help HTML
        ...
        return {
            ...
            init: function (mizar, pm, im, gl, conf) {
                ...
                $rightDiv.css('max-width', $('#' + planet.renderContext.canvas.id).width() / 4);
