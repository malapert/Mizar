 ...
 */
define(["jquery", "./UWSManager", "service/Samp", "gui/dialog/ErrorDialog", "gw/Utils/UtilsCore", "underscore-min", "text!templates/healpixCutService.html", "text!templates/cutResultItem.html", "jquery.ui"],
        ...
        return {
            ...
            addService: function (tabs, context) {
                ...
                $('#HEALPixCutBtn').button().click(function (event) {
                    ...
                    var astro = UtilsCore.getAstroCoordinatesFromCursorLocation(globe, navigation);

                    var parameters = UtilsCore.getHEALPixCutCoordinates(event, globe, navigation);
