 ...
 *    Moc base module
 */
define(["jquery", "gw/Renderer/FeatureStyle", "gw/Layer/MocLayer", "gw/Utils/Utils", "gw/Layer/FitsLoader", "gw/Tiling/HEALPixBase"],
    function ($, FeatureStyle, MocLayer, Utils, FitsLoader, HEALPixBase) {
        var mizarCore;
       ...
       function requestSkyCoverage (layer, callback) {
        ...
        function handleMocLayer(layer, mocServiceUrl) {
            ...
            // if ( layer.planet && layer.getVisible() )
            // {
            // Add sublayer to engine
            layer.planet.addLayer(serviceLayer);
            // }
