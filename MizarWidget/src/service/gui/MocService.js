 ...
 */
define(["jquery", "underscore-min", "service/MocBase", "gw/Utils/UtilsCore", "text!templates/mocServiceItem.html"],
    function ($, _, MocBase, UtilsCore, mocServiceHTMLTemplate) {
        ...
        function addHTMLMocLayer(layer) {
            ...
            $(content)
                ...
                .attr("checked", (serviceLayer && serviceLayer.getVisible()) ? true : false)
