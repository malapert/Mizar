define(['../Utils/Utils', '../Navigation/BaseNavigation', '../Renderer/Ray', 'glMatrix'], function (Utils, BaseNavigation, Ray) {
    ...
    Navigation.prototype.pan = function (dx, dy) {
        ...
        dir = vec3.subtract(point, prevPoint, vec3.create());
        vec3.subtract(this.center, dir);

        this.computeViewMatrix();

        // Recompute center
        dir = vec3.subtract(this.center, ray.orig, vec3.create());
        vec3.normalize(dir);
