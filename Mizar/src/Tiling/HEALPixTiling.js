define(['./Tile', './HEALPixBase', '../Renderer/GeoBound', '../CoordinateSystem/EquatorialCoordinateSystem', '../Utils/Numeric'],
      ...
      HEALPixTile.prototype.generateVertices = function () {
          ...
          for (var u = 0; u < size; u++) {
              for (var v = 0; v < size; v++) {
                  ...
                  vertice[0] *= this.config.coordinateSystem.geoide.radius;
                  vertice[1] *= this.config.coordinateSystem.geoide.radius;
                  vertice[2] *= this.config.coordinateSystem.geoide.radius;
