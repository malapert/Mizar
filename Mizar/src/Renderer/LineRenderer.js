define( ['../Utils/Utils', '../Utils/Numeric', './VectorRenderer','./VectorRendererManager','./Program','./BatchRenderable'],
...
/**************************************************************************************************************/
 ...
 /**
 	...
 	@constructor
 	*/
var LineRenderer = function(planet)
{
...
VectorRendererManager.factory.push( function(planet) { return new LineRenderer(planet); } );
