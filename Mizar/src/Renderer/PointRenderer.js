define( ['../Utils/Utils','./VectorRenderer','./VectorRendererManager','./FeatureStyle','./Program','./GeoBound'],
	function(Utils,VectorRenderer,VectorRendererManager,FeatureStyle,Program,GeoBound) {
...
/**************************************************************************************************************/
 ...
 /**
	...
	@augments VectorRenderer
 	@constructor
 	*/
var PointRenderer = function(planet)
{
	VectorRenderer.prototype.constructor.call( this, planet );

	// Store object for rendering
	this.renderContext = planet.tileManager.renderContext;
	this.tileConfig = planet.tileManager.tileConfig;
...
PointRenderable.prototype.add = function(geometry)
{
	...
	var coordinateSystem = this.bucket.layer.planet.coordinateSystem;
  ...
  var scale;
	...
	for ( var n = start; n < end; n++ )
	{
		...
		for ( var i = 0; i < renderable.points.length; i++ )
		{
			...
			var scaleInKm = (scale / this.planet.coordinateSystem.geoide.heightScale) * 0.001;
...
PointRenderer.prototype.canApply = function(type,style)
{
	...
	return ( (type === "Point") && (style.iconUrl === null) );
};

/**************************************************************************************************************/

// Register the renderer
VectorRendererManager.factory.push( function(planet) { return new PointRenderer(planet); } );
