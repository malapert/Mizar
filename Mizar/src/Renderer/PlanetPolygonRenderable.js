...
/**************************************************************************************************************/
 /**
	...
	@augments TiledVectorRenderer
 	...
 	@constructor
 	*/
var PlanetPolygonRenderer = function( planet )
{
	TiledVectorRenderer.prototype.constructor.call(this,planet);
};
...
VectorRendererManager.factory.push( function(planet) { return new PlanetPolygonRenderer(planet); } );
