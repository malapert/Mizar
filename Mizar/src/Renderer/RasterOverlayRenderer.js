...
var RasterOverlayRenderer = function(planet)
{
	...
	this.rendererManager = planet.vectorRendererManager;
...
RasterOverlayRenderable.prototype.onRequestStarted = function(request)
{
	...
	{
		layer.planet.publish('startLoad',layer);
	}
	layer._numRequests++;
};
...
RasterOverlayRenderable.prototype.onRequestFinished = function(completed)
{
	...
	var layer = this.bucket.layer;
	layer._numRequests--;
	if ( layer.planet && layer._numRequests === 0 )
	{
		layer.planet.publish('endLoad',layer);
	}
};
