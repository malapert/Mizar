 ...
 */
define(["jquery", "./AbstractProvider", "../Renderer/FeatureStyle", "../Layer/LayerManager", "../Utils/Utils"],
            ...
            for (var i = 0; i < namesTab.length; i++) {
                ...
                for (var j = 0; j < catalogueTab.length; j++) {
                    ...
                    if (parseInt(word[2]) === HR) {
                        ...
                        var geo = [];
                        mizarLayer.planet.coordinateSystem.fromEquatorialToGeo([raString, declString], geo);
